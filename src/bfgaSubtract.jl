module bfgaSubtract
    ...
    function fitness(ent, instructionsSet)
        ...
        @sync for i in 1:l_trainingExamples
            ...
            @async score += fitness_aux(ent, nbs[1], nbs[2], instructionsSet)
    ...
    function getParams()
        ...
        =#
        logfile = open("../Results/logSubtract.log", "w")
...
function test_serial()
    GeneticAlgorithms.runga(bfga, bfgaSubtract) #, initial_pop_size = 135)
end
